...
public class CustomerRepository : BaseRepository, ICustomerRepository
{
    ...
    {
        var query = $@"INSERT INTO {TableNames.customer}(name, password, gender, date_of_birth,email, mobile, customer_address)
        VALUES(@Name, @Password, @Gender, @DateOfBirth, @Email, @Mobile, @CustomerAddress) RETURNING *";
